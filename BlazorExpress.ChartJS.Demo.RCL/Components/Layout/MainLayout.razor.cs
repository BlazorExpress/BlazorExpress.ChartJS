...
public partial class MainLayout : MainLayoutBase
{
    internal override IEnumerable<NavItem> GetNavItems()
    {
        navItems ??= new List<NavItem>
        {
            ...
            new (){ Id = "399", Text = "API Documentation", Href = "/charts/bar-chart/api-documentation", IconName = IconName.FileText, ParentId = "3", },
            ...
            new (){ Id = "499", Text = "API Documentation", Href = "/charts/doughnut-chart/api-documentation", IconName = IconName.FileText, ParentId = "4", },
            ...
            new (){ Id = "599", Text = "API Documentation", Href = "/charts/line-chart/api-documentation", IconName = IconName.FileText, ParentId = "5", },
            new (){ Id = "500", Text = "Line", Href = "/charts/line-chart", IconName = IconName.GraphUp, ParentId = "5", Match = NavLinkMatch.All },
            new (){ Id = "500", Text = "Data labels", Href = "/charts/line-chart/data-labels", IconName = IconName.Bookmarks, ParentId = "5", Match = NavLinkMatch.All },
            ...
            new (){ Id = "699", Text = "API Documentation", Href = "/charts/pie-chart/api-documentation", IconName = IconName.FileText, ParentId = "6", },
            new (){ Id = "600", Text = "Pie", Href = "/charts/pie-chart", IconName = IconName.PieChart, ParentId = "6", Match = NavLinkMatch.All },
            new (){ Id = "600", Text = "Data labels", Href = "/charts/pie-chart/data-labels", IconName = IconName.Bookmarks, ParentId = "6", Match = NavLinkMatch.All },
            new (){ Id = "600", Text = "Legend position", Href = "/charts/pie-chart/legend", IconName = IconName.Signpost, ParentId = "6", Match = NavLinkMatch.All },
        };
