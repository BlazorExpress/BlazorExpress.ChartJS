...
public partial class MainLayout : MainLayoutBase
{
    internal override IEnumerable<NavItem> GetNavItems()
    {
        navItems ??= new List<NavItem>
        {
            ...
            new (){ Id = "300", Text = "API", Href = "/charts/doughnut-chart", IconName = IconName.CircleFill, ParentId = "6", Match = NavLinkMatch.All },

            new (){ Id = "4", Text = "Line Chart", IconName = IconName.GraphUp },
            new (){ Id = "400", Text = "API", Href = "/charts/line-chart", IconName = IconName.GraphUp, ParentId = "6", Match = NavLinkMatch.All },

            new (){ Id = "5", Text = "Pie Chart", IconName = IconName.PieChartFill },
            new (){ Id = "500", Text = "API", Href = "/charts/pie-chart", IconName = IconName.PieChartFill, ParentId = "6", Match = NavLinkMatch.All },
